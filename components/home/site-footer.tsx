    ...
    >
      ...
      <div className="flex flex-col items-center gap-6 sm:flex-row sm:gap-8 lg:gap-[80px]">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 lg:gap-[48px]">
          ...
          <Link
            href="/home-page-saa"
            className="flex cursor-pointer items-center gap-1 p-4 transition-colors duration-200 hover:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFEA9E] focus-visible:ring-offset-1"
          >
          ...
          <Link
            ...
            className="flex cursor-pointer items-center gap-1 bg-[rgba(255,234,158,0.1)] p-4 transition-colors duration-200 hover:bg-[rgba(255,234,158,0.18)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFEA9E] focus-visible:ring-offset-1"
          >
