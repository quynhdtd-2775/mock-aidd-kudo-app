...
export async function SunKudosSection() {
  ...
  return (
    // mm:3390:10349
    <section className="relative mx-auto w-full max-w-[1120px] min-h-[560px] overflow-hidden rounded-2xl lg:h-[500px] lg:min-h-0">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="relative flex w-full flex-col items-start justify-center gap-6 px-6 py-10 sm:gap-8 sm:px-10 sm:py-12 lg:absolute lg:left-[64px] lg:top-[46px] lg:w-[457px] lg:px-0 lg:py-0"
        >
          {/* mm:I3390:10349;313:8420 */}
          <div className="flex w-full max-w-[457px] flex-col items-start gap-4">
          ...
          <div className="flex w-full max-w-[457px] flex-col items-start gap-6">
        ...
        <div
          ...
          style={{ left: 736, top: 142, width: 264, height: 219 }}
        />

        {/* mm:I3390:10349;329:2948 — decorative, desktop-only */}
        <div
          className="absolute hidden lg:block"
          style={{ left: 672, top: 215, width: 364, height: 72 }}
        >
          <Image
